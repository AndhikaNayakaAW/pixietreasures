...
import 'package:pixietreasures/widgets/product_card.dart'; // Adjusted import path
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // The title of the application "PixieTreasures" with white text and bold font.
